...
public class DailyReceivedSalesAmountsByOperatorRes {
    ...
    */
    public Double ReceivedSalesAmountCurrency;
    public Double getReceivedSalesAmountCurrency() {
       return ReceivedSalesAmountCurrency;
    }
    protected void setReceivedSalesAmountCurrency(Double value) {
       ReceivedSalesAmountCurrency = value;
    }
}
